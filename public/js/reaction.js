$(document).ready(function () {
    $(".emoji").on("click", function () {
        ...
        $(this).parent().siblings('.default-like-button').attr('src', '/images/reactions_' + data_reaction.toLowerCase() + '.png');
        $(this).parent().siblings('.reaction-text').text(data_reaction);
